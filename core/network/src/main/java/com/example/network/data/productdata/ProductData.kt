package com.example.network.data.productdata

import com.example.network.data.productdata.categoriproduct.CategoriProductData
import com.example.network.data.productdata.hostdata.HostData
import com.example.network.data.productdata.order.OrderData
import com.example.network.data.productdata.photodata.cover.CoverPhotoData
import com.example.network.data.productdata.photodata.main.MainPhotoData
import com.example.network.data.productdata.place.BeginPlaceData
